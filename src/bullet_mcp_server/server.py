...
def ensure_physics_client():
    ...
    if simulation_state["physics_client"] is None:
        # Use DIRECT mode for headless operation (suitable for MCP server)
    ...
    return [
        types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {
                    "mode": {"type": "string", "enum": ["GUI", "DIRECT"], "default": "DIRECT"},
        ...
        types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {
                    "urdf_file": {"type": "string", "description": "URDF file name (e.g., 'cube.urdf', 'r2d2.urdf')"},
                    "position": {"type": "array", "items": {"type": "number"}, "default": [0, 0, 1]},
                    "orientation": {"type": "array", "items": {"type": "number"}, "default": [0, 0, 0, 1]},
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "flags": {"type": "string", "enum": ["WORLD_FRAME", "LINK_FRAME"], "default": "WORLD_FRAME"}
                },
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "object_id": {"type": "integer"},
                    "linear_velocity": {"type": "array", "items": {"type": "number"}, "default": [0, 0, 0]},
                    "angular_velocity": {"type": "array", "items": {"type": "number"}, "default": [0, 0, 0]}
                },
                "required": ["object_id"]
            }
        ),
        ...
        types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {
                    "num_objects": {"type": "integer", "default": 10, "minimum": 1, "maximum": 50},
                    "object_types": {"type": "array", "items": {"type": "string"}, "default": ["cube", "sphere"]},
...
async def handle_call_tool(
    ...
    try:
        if name == "create_simulation":
            ...
            # Create new physics client
            mode_id = p.GUI if mode == "GUI" else p.DIRECT
            simulation_state["physics_client"] = p.connect(mode_id)
            p.setAdditionalSearchPath(pybullet_data.getDataPath())
            ...
            return [types.TextContent(
                type="text",
                text=f"Created physics simulation in {mode} mode with gravity {gravity}"
            )]
            ...
            return [types.TextContent(
                type="text",
                text=f"Set color of object {obj_id} to {color}"
            )]
            ...
            return [types.TextContent(
                type="text",
                text=f"Stepped simulation {steps} step(s)"
            )]
            ...
            for i in range(num_objects):
                ...
                urdf_file = f"{obj_type}_small.urdf" if obj_type in ["cube", "sphere"] else f"{obj_type}.urdf"
